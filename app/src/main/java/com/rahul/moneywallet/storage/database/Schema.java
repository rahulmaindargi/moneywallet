...
/*package-local*/ class Schema {
    ...
    /*package-local*/ static final String CREATE_TABLE_TRANSFER_ATTACHMENT = "CREATE TABLE " + TransferAttachment.TABLE + " (" +
            ...
            "(" + Attachment.ID + ") ON UPDATE NO ACTION ON DELETE CASCADE " +
            ")";
    /*package-local*/ static final String CREATE_TABLE_SMS_FORMAT = "CREATE TABLE " + SMSFormat.TABLE + " (" +
            SMSFormat.TYPE + " TEXT NOT NULL, " +
            SMSFormat.SENDER + " TEXT NOT NULL, " +
            SMSFormat.REGEX_FORMAT + " TEXT NOT NULL, " +
            SMSFormat.UUID + " TEXT NOT NULL UNIQUE, " +
            SMSFormat.LAST_EDIT + " INTEGER NOT NULL, " +
            SMSFormat.DELETED + " INTEGER NOT NULL DEFAULT 0, " +
            "PRIMARY KEY (" + SMSFormat.UUID + ")" +
            ")";

    /*package-local*/ static final String CREATE_TABLE_SMS_MESSAGE = "CREATE TABLE " + SMSMessage.TABLE + " (" +
            SMSMessage.MESSAGE + " TEXT NOT NULL, " +
            SMSMessage.UUID + " TEXT NOT NULL UNIQUE, " +
            SMSMessage.LAST_EDIT + " INTEGER NOT NULL, " +
            SMSMessage.DELETED + " INTEGER NOT NULL DEFAULT 0, " +
            "PRIMARY KEY (" + SMSMessage.UUID + ")" +
            ")";
    ...
    /*package-local*/ static final class SMSFormat extends BaseTable {
        /*package-local*/ static final String TABLE = "sms_format";
        /*package-local*/ static final String TYPE = "_type";
        /*package-local*/ static final String SENDER = "_sender";
        /*package-local*/ static final String REGEX_FORMAT = "_regex_format";
    }

    /*package-local*/ static final class SMSMessage extends BaseTable {
        /*package-local*/ static final String TABLE = "sms_message";
        /*package-local*/ static final String MESSAGE = "_message_text";
    }
