...
public class SMSDataImporter extends AbstractDataImporter {
    ...
    @Override
    protected void insertTransaction(String wallet, CurrencyUnit currencyUnit, String category, Date datetime, Long money, int direction,
                                     String description, String event, String place, String people, String note) {
        ...
        super.insertTransaction(wallet, currencyUnit, category, datetime, money, direction, description, event, place, people, note);
